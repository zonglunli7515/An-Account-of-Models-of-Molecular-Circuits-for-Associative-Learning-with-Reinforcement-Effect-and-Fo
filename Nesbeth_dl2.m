%%% This file is used for the adapted new model%%%

alpha_yx = 4; alpha_yz = 1; alpha_xyz = 4; alpha_ux = 0.6; alpha_vx = 1; %2
...
for i=1:n-1
   fy = alpha_yx * X(i)^a/(1+X(i)^a) * 1/(1+V(i)^a) ...
       +alpha_yz * Z(i)^a/(1+Z(i)^a) ...
       -Y(i);
